...
Walk me through this.`,
  ...
  koaBarks: {
    ...
    // Turn 3: Story completion patterns
    // Patterns generated by game store based on evidence type composition
    storyCompletions: {
      // All same type (3 of 3)
      all_digital: [
        "Three digital sources. Your alibi is server-side. No humans involved.",
      ],
      all_sensor: [
        "All sensor data. The house has opinions. Whether they're accurate is another question.",
      ],
      all_testimony: [
        "All humans vouching. No devices. Bold strategy in a smart home.",
      ],
      // Two of one type (2 of 3)
      digital_heavy: [
        "Two digital sources. Your alibi is mostly bits and bytes.",
      ],
      sensor_heavy: [
        "Two sensors out of three. You trust your devices. They might not trust you back.",
      ],
      testimony_heavy: [
        "Two humans, one device. You prefer witnesses to data. Noted.",
      ],
      // All different types
      mixed_strong: [
        "Varied sources. Harder to dismiss when they don't all come from the same place.",
      ],
      mixed_varied: [
        "Different angles. We'll see if they actually agree.",
      ],
    },
