> <Override> From user: implement <feature-name>. Use Opus only. Use gemini for review. Don't forget to pass respective prompt to subagents. Keep going until all waves are done. Only stop if you encounter a blocking issue. Wait for further instructions after completing all waves. Don't run integration audit subagents unless I explicitly ask you to.
...
- FOLLOW STEP 1-14 IN ORDER. DO NOT SKIP STEPS.
...
** IMPORTANT: EVERY SUBAGENT NEEDS TO BE PASSED THE APROPRIATE SUBAGENT PROMPT **
TASKS/WAVE - {process}/prompts/waves/IMPLEMENTER-SUBAGENT-TASK.md
REVIEWER - {process}/prompts/waves/REVIEWER-SUBAGENT-WAVE.md
INTEGRATION AUDITOR - {process}/prompts/waves/IMPLEMENTER-SUBAGENT-TASK
...
** NOTE THAT THE REVIEW IS INSTRUCTED TO FIND AT LEAST 3 ISSUES, SO CERTAIN ISSUES MAY BE MADE UP OR NON-ISSUE **
** PASS TO REVIEWER INSTRUCTION PROMPT - {process}/prompts/waves/REVIEWER-SUBAGENT-WAVE.md
