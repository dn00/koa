...
#
# Purpose: Review a feature plan + task files for internal consistency,
...
task files are coherent, accurate, and implementable without surprises.
...
- One or more task files (e.g., _process/features/{feature}/tasks/NNN-*.md)
...
- Flag any potential performance pitfalls (e.g., O(n²) per tick).
