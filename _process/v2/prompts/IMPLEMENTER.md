...
Total tasks: [N]
```
If the plan includes a "Task Details (Inline)" section, treat it as the source of truth and skip task files.
...
Implement shared types/utilities first, then task-specific logic.
