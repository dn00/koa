...
You were "asleep the whole time." Prove it.`,
  ...
  cards: [
    ...
    // Microwave log — THE WEAK HERO. Low power but safe exit (risk 0, IDLE, no contradictions)
    {
      id: 'microwave', power: 2, tag: Tag.IDLE, risk: 0,
      proves: ProofType.ALERTNESS,
      source: 'smart_microwave', flavor: 'Smart microwave — no usage logged between 10pm and 7am',
    },
  ],
  counters: [
