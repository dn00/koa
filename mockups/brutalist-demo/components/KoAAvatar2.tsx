...
declare global {
    interface Window {
        KoaAvatar: {
            KoaMood: typeof KoaMood; // Expose Enum
...
if (typeof window !== 'undefined') {
    window.KoaAvatar = {
        KoaMood: KoaMood,
        render: (elementId: string, initialProps: KoAAvatarProps = {}) => {
            ...
            // Initial Render
            root.render(React.createElement(KoAAvatar, currentProps));

            return {
                unmount: () => root.unmount(),
                update: (newProps: KoAAvatarProps) => {
